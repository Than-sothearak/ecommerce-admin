...
const Products = ({
  ...
  if (categories.length > 0 && products.map(p=> p.category)) {
    let selectCatInfo = categories.find(({ _id }) => _id === products.category);
    categoriesToFill.push(...selectCatInfo.name);
